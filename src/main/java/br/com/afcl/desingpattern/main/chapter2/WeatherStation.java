...
import br.com.afcl.desingpattern.main.chapter2.display.HeatIndexDisplay;
...
public class WeatherStation {
	public static void main(String[] args) {
		...
		weatherData.removeObservable(forecastDisplay);
		weatherData.removeObservable(heatIndexDisplay);

		weatherData.setMeasurements(78, 90, 29.2f);
		weatherData.setMeasurements(60, 92, 25.1f);

        weatherData.removeObservable(statisticsDisplay);
        weatherData.removeObservable(currentConditionsDisplay);
	}
}
